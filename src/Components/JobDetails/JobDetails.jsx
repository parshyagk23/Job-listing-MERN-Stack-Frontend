        ...
        <main className="pt-20 pb-16">
          <section className="w-9/12 h-24 mx-40 mt-10 bg-slate-100 md:mx-24 xs:w-11/12 xs:mx-4 ">
            <h1 className="font-medium text-3xl text-center pt-3 rounded-md xs:text-xl ">
              {Jobdetail.JobPosition} work from{" "}
              {Jobdetail?.LocationType === "Remote" ? "Home" : "Office"}{" "}
              {Jobdetail.JobType === "full time " ? "job" : "internship "}
          ...
          <section className="w-4/5 bg-slate-100 mt-10 mx-32 p-8 md:mx-20  xs:w-11/12 xs:mx-4 ">
            <div className="flex gap-2">
              ...
              <img
                src={Jobdetail ? Jobdetail.logoUrl : companylogo}
                width="30px"
                height="30px"
                alt=""
              />
            ...
            <div className="flex gap-7 mt-3">
              <div>
                <span className="flex gap-3">
                  ...
                  <h5 className="font-normal text-lg text-slate-400">
                    Stipend
                  </h5>
                </span>
                <h1 className="font-medium text-xl text-slate-600">
                  {Jobdetail?.MonthlySalary}/month
                </h1>
              </div>
              <div>
            ...
            <section className="mt-5">
              ...
              <div className="grid grid-cols-7 gap-1 md:grid-cols-4 lg:grid-cols-6 xs:grid-cols-3  ">
                {Jobdetail?.Skills.map((skill, index) => (
                  <div
                    key={index}
                    className="min-h-10 mt-2 rounded-full  font-normal text-slate-700 text-2xl text-start  "
                  >
                    {skill}
                  </div>
                ))}
